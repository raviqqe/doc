...
them already; if tree shaking reduces the size of main programs, that
is the implication of unused procedures and variables there, or
potentially bugs.
...
For instance, when we define a variable with \texttt{define} syntax and
