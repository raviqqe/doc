...
Scheme interpreters compare in the benchmarks.
For Stak Scheme, we run benchmarks against its bytecode interpreters as well
which run pre-compiled bytecode directly emulating situations of
embedded scripting describe in \ref{stak}.
