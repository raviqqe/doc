...
\acmConference[Scheme 2025]{Scheme Workshop in ICFP/SPLASH
2025}{October 16, 2025}{Singapore}
...
In the design of the bytecode, we pursue portability and compactness of both
bytecode formats on memory and disk and the bytecode decoder which the
virtual machine is equipped with.
