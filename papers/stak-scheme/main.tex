...
\begin{itemize}
  ...
  \item We propose our simple bytecode encoding and decoding algorithms
    ...
    decode both code and data uniformly.
\end{itemize}
...
Thus, Scheme-to-C compilers are not the best approach for small
Scheme implementations due to duplication of logic between the
