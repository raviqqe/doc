...
\begin{abstract}
  ...
  its core parts are composed of a bytecode compiler written in 1.5 KLOC of Scheme
...
\begin{itemize}
  \item We provide the smallest R7RS-small implementation ever in
    ...
    The core parts of the implementation are composed only of a 1.5 KLOC bytecode
...
bytecode into its serialized format and writes it into output files.
...
pointers into heap memory on the virtual machine.
