...
against. In order to measure

\begin{description}
  \item[empty] The TR7 interpreter at the commit \texttt{e821e555}
    on the \texttt{v2} branch
  \item[] The interpreter of Gambit Scheme v4.9.7
...
\begin{description}
  \item[mstak] Stak Scheme 0.10.38 (integer only, libc)
  \item[stak] Stak Scheme 0.10.38 (the \texttt{std} library in Rust)
