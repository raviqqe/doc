...
against.
In addition to typical micro benchmarks of \texttt{fibonacci},
\texttt{sum}, and \texttt{tak} for pure computations, we also added
\texttt{empty} and \texttt{hello} in order to assess the interpreters'
lightweight-ness, which is often impactful in embedded situations.
...
\begin{description}
  ...
  \item[stak] Stak Scheme 0.10.38 (64-bit floating point number, the
...
ranging from 1.67 times faster to 4.35 times slower,
