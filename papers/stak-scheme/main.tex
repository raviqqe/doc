...
Following the bytecode design in Ribbit Scheme \cite{ribbit2023}, we pursue
portability and compactness of both the bytecode formats on memory
and disk and the bytecode decoder which the virtual machine is equipped with.
