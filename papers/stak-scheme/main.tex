...
for small Scheme programs already, Stak Scheme's encoding algorithm
deviates from it to encode and decode larger chunks of bytecode.

The key motivation to introduce our new encoding and decoding
algorithms different from those of Ribbit Scheme is the differences
...
In Ribbit Scheme, the bytecode encoding requires a global symbol table.
