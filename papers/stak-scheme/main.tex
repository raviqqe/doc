...
deviates from it for two primary points.
...
values uniformly in a single chunk of bytecode even when the
immediate values are not of primitive data types.
This approach also allows direct translation of symbols from
