...
We strip debug information from these executable files as well because
our focus is size comparison of the interpreter logic itself.

Table \ref{table:binary} shows the sizes of the executable files.
The numbers are without the sizes of dynamic libraries common among
