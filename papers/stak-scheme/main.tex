...
We compile these executable files for x86-64 on Ubuntu 24.04 with
the Linux kernel at version 6.14.1.
For the comparison, we use the version of Stak Scheme (\texttt{stak})
