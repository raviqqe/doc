...
\begin{itemize}
  ...
  \item We propose our simple bytecode encoding and decoding algorithms
    ...
    decodes codes and data in bytecode uniformly.
\end{itemize}
...
decoding algorithms that convert codes and data in bytecode
...
into byte sequences.
The virtual machine decodes the serialized bytecode back into their
...
bytecode in their in-memory format. Note that we use the same
