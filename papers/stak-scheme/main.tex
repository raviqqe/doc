...
been used for such scripting purpose, such as
Script-Fu\footnote{https://developer.gimp.org/resource/writing-a-plug-in/tutorial-script-fu/}
in GIMP, Guile\footnote{https://www.gnu.org/software/guile/} in
several GNU applications, and
AutoLISP\footnote{https://en.wikipedia.org/wiki/AutoLISP} in AutoCAD.
