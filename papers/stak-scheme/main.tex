...
Thus, although Ribbit Scheme Stak implements the \texttt{apply}
...
of the \texttt{apply} procedure resides in the logic of the
\texttt{call} instruction.
...
Ribbit Virtual Machines (RVMs) implemented in various programming languages
