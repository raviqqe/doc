...
Unlike the statement in the Ribbit Scheme paper
\cite{ribbit7kb2023} where they estimate the R7RS-small
implementation on top of Ribbit Scheme would range from 15 KB to 30
KB in its binary size, Stak Scheme weighs over 100 KB.
