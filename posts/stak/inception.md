...
Although this is beneficial for stripping down extra bytes from artifacts, it comes with some pain points. And the primary one is duplication of logic compiling S-expressions into bytecodes.
