...
By implementing all of those optimizations in [the Koka programming language](https://github.com/koka-lang/koka), they achieved GC overhead much less than other languages in several common algorithms and data structures, such as red-black tree. For more information, see [the latest version of the paper][perceus].
