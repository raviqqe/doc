...
Finally, I would appreciate if you give feedback on this post and [the Pen programming language][pen]. Thanks for reading! The language's new release has been blocked by [LLVM 14 adoption in Homebrew](https://github.com/Homebrew/homebrew-core/pull/97618) but it had some progress recently. So I can probably release v0.4 of it soon.
